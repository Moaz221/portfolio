          ...
          <div key={p.id} className="card p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="mt-3">
              ...
              {!p.isSecure && p.hasVideo && <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {p.apkUrl ? <a href={p.apkUrl} download rel="noopener noreferrer" className="apk-btn py-3.5"><SVGIcon d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z" size={18} fill="#fff"/> Download APK</a> : <a href="https://youtu.be/_yb3U57rSRw?si=3mQ0jfvSW2nHyB12" target="_blank" rel="noopener noreferrer" className="apk-btn py-3.5">Watch on YouTube</a>}
              </div>}
